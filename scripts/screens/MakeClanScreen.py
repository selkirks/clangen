...
class MakeClanScreen(Screens):
    ...
    # values are ((x position, y position), (x width, y height))
        ...
        if self.page == 0:
            ...
            self.elements['eye color'] = pygame_gui.elements.UIDropDownMenu(Pelt.eye_colors, str(self.eye_color), scale(pygame.Rect((column3_x, y_pos[8]),(250,70))), manager=MANAGER)
