...
class Pelt:
    ...
    eye_colours = ['SUNLITICE', 'LEMON', 'YELLOW', 'CITRINE', 'HONEY', 'SUNFLOWER', 'GOLD', 'MARIGOLD', 'PEACH', 'ORANGE', 'JASPER', 'COPPER', 'CORAL', 'AMBER', 'BRONZE', 
        ...
        'BLACK', 'DARK HAZEL', 'ROSE GOLD', 'ROSE', 'REVERSE SUNLITICE', 'ICY', 'SUNSET',
        'LAVENDER', 'ECLIPSE', 'INK',
        'MUDDY', 'GEM', 'OURPLE', 'RUSTY', 'PASTEL', 'AVOCADO', 'PASTEL LAVENDER', 'ALBINO',
        'WINTER ROSE', 'SWEET', 'MORNING', 'DARK BROWN' , 'BAY', 'NEON GREEN', 'SEA', 'DISCORD', 
    ...
    yellow_eyes = ['SUNLITICE', 'LEMON', 'YELLOW', 'CITRINE', 'HONEY', 'SUNFLOWER', 'GOLD', 'MARIGOLD', 'PEACH', 'ORANGE', 'JASPER', 'COPPER', 'CORAL', 'AMBER', 'BRONZE', 
        'CRIMSON', 'FEATHER', 'BRASS', 'BROWN', 'CHOCOLATE', 'PINK', 'SWAMP', 'ASPARAGUS', 'OLIVE', 'HAZEL', 'MORNING',
    ...
    blue_eyes = ['MIST', 'CYAN', 'AQUA', 'TURQUOISE', 'SAPPHIRE', 'DOLPHIN', 'DUCK', 'TEAL', 'ARCTIC', 'SKY', 'EGG', 'CERULEAN', 'CORNFLOWER', 'BERRY', 'AZURE', 'BLUE', 
        ...
        'STONE', 'METAL', 'PURPLE', 'ICE', 'BLACK', 'REVERSE SUNLITICE', 'ICY',
        'OURPLE', 'PASTEL', 'WINTER ROSE', 
        'PASTEL LAVENDER', 'LAVENDER', 'SWEET', 'RUBY', 'WICKED', 'PHANTOM',
        "INK"]
    green_eyes = ['LIME', 'KIWI', 'PEAR', 'APPLE', 'PERIDOT', 'GREEN', 'CLOVER', 'FERN', 'JADE', 'SHAMROCK', 'EMERALD', 'FOREST', 'MINT', 'SPRING', 'OCEAN', 'JUNGLE', 
        'SAGE', 'LAUREL', 'PISTACHIO', 'MOSS', 'DARK HAZEL', 'GEM', 'AVOCADO', 'NEON GREEN', 'SEA', 'RIVER MOSS']
    ...
    eye_sprites = [
        ...
        'SUNSET', 'DARKBLUE', 'LAVENDER', 'ECLIPSE', 'INK', 
        'MUDDY', 'GEM', 'OURPLE', 'RUSTY', 'PASTEL', 'AVOCADO',
        'PASTEL LAVENDER', 'ALBINO', 'WINTER ROSE', 'SWEET', 
