...
class Sprites:
    ...
    with open(
        "sprites/dicts/living_insects_sprite_data.json", "r", encoding="utf-8"
    ) as read_file:
        LIVING_INSECTS_DATA = ujson.loads(read_file.read())
    ...
    with open(
        "sprites/dicts/companions_sprite_data.json", "r", encoding="utf-8"
    ) as read_file:
        COMPANIONS_DATA = ujson.loads(read_file.read())

    with open(
        "sprites/dicts/random_sprite_data.json", "r", encoding="utf-8"
    ) as read_file:
        RANDOM_DATA = ujson.loads(read_file.read())

    with open(
        "sprites/dicts/tail2_acc_sprite_data.json", "r", encoding="utf-8"
    ) as read_file:
        TAIL2_DATA = ujson.loads(read_file.read())

    with open(
            "sprites/dicts/bellamy_acc_sprite_data.json", "r", encoding="utf-8"
        ) as read_file:
        BELLAMY_DATA = ujson.loads(read_file.read())
