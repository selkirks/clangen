...
def amount_clanmembers_covered(all_cats, amount_per_med, clan=CatGroup.PLAYER_CLAN_ID) -> int:
    """
...
def medicine_cats_can_cover_clan(all_cats, amount_per_med, clan=CatGroup.PLAYER_CLAN_ID) -> bool:
    """
