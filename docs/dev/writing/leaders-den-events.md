...
```
> **status: list[str]** - [status list](reference/tag-lists.md#__tabbed_2_1)  In addition to leader, the following statuses can be sent to the Gathering in the leader's stead: ["leader", "deputy", "healer", "healer apprentice"]
